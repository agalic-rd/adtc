...
abstract: |
    ...
    form neurons that express reelin along with CTIP2 and GluR5, though PENK expression is not as clearly defined.
...
<object data="poster.pdf" type="application/pdf" width="100%" height="1300">
  <iframe width="100%" height="100%" style="border:none;"
    src="https://mozilla.github.io/pdf.js/web/viewer.html?file=https://www.adtc.no/content/posters/rodriguez-duboc/poster.pdf">
  </iframe>
</object>
